...
# Susceptibility
f = plt.figure(figsize = (5,5))
plt.scatter(np.array(susc)[idx_seln], all_sil_r[idx_seln,0], color='b')
plt.scatter(np.array(susc)[idx_seln], all_sil_l[idx_seln, 0], color='r')
plt.xlabel('Susceptibility')
plt.ylabel('Silhouette score')
plt.title('Susceptibility vs silhouette score: selective neurons')
print(scipy.stats.pearsonr(np.array(susc)[idx_seln], all_sil_r[idx_seln,0]))
print(scipy.stats.pearsonr(np.array(susc)[idx_seln], all_sil_l[idx_seln,0]))

# Robustness
# rob = l1.modularity_proportion_per_neuron()
f = plt.figure(figsize = (5,5))
plt.scatter(np.log(np.abs(rob)[idx_seln]), all_sil_r[idx_seln,0], color='b')
plt.scatter(np.log(np.abs(rob)[idx_seln]), all_sil_l[idx_seln, 0], color='r')
# plt.scatter(np.array(rob)[idx_seln], all_sil_r[idx_seln, 0], color='b')
# plt.scatter(np.array(rob)[idx_seln], all_sil_l[idx_seln, 0], color='r')
plt.xlabel('Log(Abs(Robustness))')
plt.ylabel('Silhouette score')
plt.title('Robustness vs silhouette score: selective neurons')
# plt.xlim(-5,5)
print(scipy.stats.pearsonr(np.log(np.abs(rob)[idx_seln]), all_sil_r[idx_seln, 0]))
print(scipy.stats.pearsonr(np.log(np.abs(rob)[idx_seln]), all_sil_l[idx_seln, 0]))

# Modularity
# mod = l1.modularity_proportion_per_neuron(period=range(l1.delay, l1.delay + int(1/l1.fs)))
f = plt.figure(figsize = (5,5))
plt.scatter(np.array(mod)[idx_seln], all_sil_r[idx_seln, 0], color='b')
plt.scatter(np.array(mod)[idx_seln], all_sil_l[idx_seln, 0], color='r')
plt.xlabel('Modularity')
plt.ylabel('Silhouette score')
plt.title('Robustness vs silhouette score: selective neurons')
print(scipy.stats.pearsonr(np.array(mod)[idx_seln], all_sil_r[idx_seln, 0]))
print(scipy.stats.pearsonr(np.array(mod)[idx_seln], all_sil_l[idx_seln, 0]))
