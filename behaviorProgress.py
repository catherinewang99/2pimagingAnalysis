...
b.learning_progression(window = 50, include_delay=False, color_background=[2,3,4,5,8,9])
b.plot_performance_over_sessions(all=True, color_background=[2,3,4,5,8,9])
...
b = behavior.Behavior('H:\\data\\BAYLORCW039\\python\\2024_04_25', single=True)
