...
n=4
l,_ = l1.get_trace_matrix(n) # or 4
...
n = l2.good_neurons[np.where(l1.good_neurons == n)[0][0]]
l,_  = l2.get_trace_matrix(n) # or 4
...
f = plt.figure(figsize=(7,1))
ax = plt.imshow(l_delay_mean_exp, cmap='gray', interpolation='nearest', aspect='auto', vmin=1, vmax=2)
plt.colorbar(ax)
